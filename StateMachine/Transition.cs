...
namespace BGC.StateMachine
{
    public class Transition
    {
        ...
        public Transition(State targetState, params TransitionCondition[] transitionConditions)
        {
            if (targetState == null)
            {
                throw new ArgumentNullException("Transition target state cannot be null.");
            }
            else if (transitionConditions == null)
            {
                throw new ArgumentNullException("Transition conditions canot be null.");
            }
